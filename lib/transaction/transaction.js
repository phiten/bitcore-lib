...
Transaction.MAX_MONEY = 1500000 * 1e8;
 ...
 * and a slightly fancier format recognized by veriumcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a veriumcore Address object. The
 * same is true for `script`, which can be a string or a veriumcore Script.
 *
